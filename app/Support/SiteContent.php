    ...
    public static function defaults(): array
    {
        return [
            ...
            'home' => [
                ...
                'overview_link_text' => 'Read more about us',
                ...
                'curriculum_pillars' => [
                    ['title' => 'Mastery learning', 'description' => 'Children progress at their own pace until concepts are truly understood—not rushed through grades.'],
                    ['title' => 'Character & values', 'description' => 'Biblical principles woven into daily learning—building integrity, respect, and servant hearts.'],
                    ['title' => 'Nursery to primary', 'description' => 'A seamless journey from early foundations through P6—one caring community, one proven curriculum.'],
                    ['title' => 'Rwanda ready', 'description' => 'Preparing learners for national standards and global opportunity—trusted by parents and partners.'],
                ],
                ...
                'why_choose_empty' => 'Edit “value cards” in Admin → Settings to highlight what makes your school special for parents.',
                'news_label' => 'Gallery',
                'news_title' => 'Life at our school',
